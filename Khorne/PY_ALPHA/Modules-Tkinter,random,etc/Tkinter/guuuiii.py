...
import sqlite3
dbase=sqlite3.connect('hellotk.db')
...
def submit():
      ...
      print(deptval)
      print(regnoval)
      dbase.execute('INSERT INTO MAIN_PAGE(NAME,DEPT,REGNO)VALUES(?,?,?)',(nameval,deptval,regnoval))
      dbase.commit()
...
lb1=Label(app,text='Enter your name : ',font=('Jokerman',28),bg='#6ac2e9',fg='red')
lb1.grid(row=0,column=0,padx=15,pady=15)
ent1=Entry(app,font=('Jokerman',28),bg='green',fg='pink',textvariable=name)
...
ent2=Entry(app,font=('Jokerman',28),bg='green',fg='pink',textvariable=dept)
...
ent3=Entry(app,font=('Jokerman',28),bg='green',fg='pink',textvariable=regno)
